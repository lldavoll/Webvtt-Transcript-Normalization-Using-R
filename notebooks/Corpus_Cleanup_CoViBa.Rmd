...
your_wd <- "C:/Users/ateni/Desktop/U of A/EXPERIMENTOS/CoVIBA"

stopifnot(dir.exists(your_wd))
setwd(your_wd)
...
# Pre-allocate data frame (avoid growing it inside the loop)
files <- data.frame(
...
# Collect names and text content
for (i in seq_along(filelist)) {
  files$Name[i] <- paste0("Cleaned_", filelist[i])
  files$Text[i] <- read_file(filelist[i])
}
```
